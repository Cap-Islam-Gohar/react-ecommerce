...
export default function Alert(props){
    ...
    return (Boolean(when) && <> 
        <div className="w-full my-3">
            <div className={clsx('p-4 rounded-md', type === 'success' && 'bg-green-50', type === 'error' && 'bg-red-50') }>
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className={clsx('font-medium text-sm', type === 'success' && 'text-green-800', type === 'error' && 'text-red-800') }>
                    ...
                    {onClose && <div className="pl-3 ml-auto">
                        <div className="-m-1.5">
                            <button type="button" onClick={onClose}
                                ...
                                <XMarkIcon className={clsx('w-5 h-5', type === 'success' && 'text-green-800', type === 'error' && 'text-red-800') }></XMarkIcon>
                            </button>
                        </div>
                    </div>}
                </div>
